...
//     ItemData("assets/images/ring-road.jpg", "Edo Social Citizen App", Wrap(direction: Axis.horizontal, //default
//   alignment: WrapAlignment.center, children: [Text('This app bridges the communication gap between the Government and citizens of Edo state and promote financial inclusion that guarantee social empowerment and financial services', textAlign: TextAlign.center, style: TextStyle(fontSize: 60.0),)])),
