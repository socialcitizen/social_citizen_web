...
class MySliverDelegate extends StatelessWidget {
  const MySliverDelegate({Key key}) : super(key: key);
                      ...
                      Padding(
                        ...
                        child: Container(                                          
                          ...
                          child: Padding(
                            padding: const EdgeInsets.all(8.0),
                            child: MySmallText(
                              text: "Know your Government Agencies. Connect and engage. It's all free.",
                            )
                          )
                        )
                      )
